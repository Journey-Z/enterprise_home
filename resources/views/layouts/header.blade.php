<div class="header dw zoom">
    ...
    <div class="fr menuBox">
        <ul class="zoom">
            ...
            <li @if($category_name == "culture")class="on" @endif><a href="{{route('category_detail', ['category_name' => 'culture'])}}">文化与责任</a></li>
            <li @if($category_name == "team_build")class="on" @endif><a href="{{route('category_detail', ['category_name' => 'team_build'])}}">团队建设</a></li>
